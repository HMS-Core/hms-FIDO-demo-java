...
public class Fido2DemoMainActivity extends AppCompatActivity {
    ...
    public void onClickAuthentication(View view) {
        ...
        boolean isUseSelectedPlatformAuthenticator = Attachment.PLATFORM.getValue().equals(attachmentMode);

        PublicKeyCredentialRequestOptions publicKeyCredentialCreationOptions =
                ServerUtils.convert2PublicKeyCredentialRequestOptions(fido2Client,response,isUseSelectedPlatformAuthenticator);
    ...
    private void showError(String message, Fido2Response fido2Response) {
        ...
        errMsgBuilder.append(message)
                ...
                .append(String.format(Locale.ENGLISH, "(CtapStatus: 0x%x=%s)", fido2Response.getCtapStatus(),
    ...
    private ServerAuthenticatorSelectionCriteria getAuthenticatorSelectionCriteria(
            String userVerificationLevel, String attachmentMdoe, Boolean residentKey) {
